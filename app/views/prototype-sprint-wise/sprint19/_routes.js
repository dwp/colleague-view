...
router.post('/opt1/engagement-type', function (req, res) {
  ...
  if (req.session.data['national-insurance-number-for-ur4'] == 'QQ123456Q' || req.session.data['national-insurance-number-for-ur4'] == 'qq123456q') {
    ...
    res.render('prototype-sprint-wise/sprint19/opt1/engagement-type')
  } else {
    var errMsg = "";
    ...
    res.render('prototype-sprint-wise/sprint19/opt1/error-NINO-number', { "errMsg": errMsg });
  }
})
...
router.post('/opt2/engagement-type', function (req, res) {
  ...
  if (req.session.data['national-insurance-number-for-ur4_2'] == 'QQ123456Q' || req.session.data['national-insurance-number-for-ur4_2'] == 'qq123456q') {
    // Send user to next page
    res.render('prototype-sprint-wise/sprint19/opt2/engagement-type')
  } else {
    var errMsg = "";
    ...
    // Send user to error page
    res.render('prototype-sprint-wise/sprint19/opt2/error-NINO-number', { "errMsg": errMsg });
  }
})
  
// End of sprint19 here
