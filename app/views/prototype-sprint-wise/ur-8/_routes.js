...
// ----for CA with ESA----
router.post(
  '/a/call-log-journey/benefit-question-asked/ca-eas/questions-outcomes-ca',
  function (req, res) {
    ...
    if (req.session.data['whichBenefitDiscussed'].includes('Carer Allowance')) {
      if (req.session.data['questionAsk-ca'].includes('Something else')) {
        ...
        if (
          req.session.data['questionAsk-ca'].includes('Next payment amount')
        ) {
        ...
        if (
          req.session.data['questionAsk-ca'].includes(
        ...
        //All variable render here
        res.render(
          'prototype-sprint-wise/ur-8/a/call-log-journey/benefit-question-asked/ca-eas/questionAnswered-ca',
          {
            isNpdCA: isNpdCA,
            isNpaCA: isNpaCA,
            isMpCA: isMpCA,
...
// ----for ESA with CA----
router.post(
  '/a/call-log-journey/benefit-question-asked/ca-eas/questions-outcomes-esa',
  function (req, res) {
    ...
    if (
      ...
      if (req.session.data['questionAsk-esa'].includes('Something else')) {
        ...
        //All variable render here
        res.render(
          'prototype-sprint-wise/ur-8/a/call-log-journey/benefit-question-asked/ca-eas/questionAnswered-esa',
          {
            isNpdESA: isNpdESA,
            isNpaESA: isNpaESA,
            isMpESA: isMpESA,
