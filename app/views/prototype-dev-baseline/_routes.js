...
const dataMVP1_0 = require('./mvp-1_0/data.json');
const paymentDataMVP1_0 = require('./mvp-1_0/payment-data.json');
const paymentDataDiffentUserMVP1_0 = require('./mvp-1_0/different-type-contact-user/payment-data.json');
const paymentDataViewOnlyIserMVP1_0 = require('./mvp-1_0/view-only-user/payment-data.json');
// Add your routes here - above the module.exports line

// for MVP 1.0 (both type of users)
router.get('/mvp-1_0/call-log-journey/unHappy_journey/noBenefit/added-call-info',function(req,res,next){
let notes ='';
...
router.get('/mvp-1_0/different-type-contact-user/call-log-journey/unHappy_journey/noBenefit/added-details',function(req,res,next){
let notes ='';
if(req.session.data.notes){
if(req.session.data.notes.length>0){
notes =req.session.data.notes + ". "+ req.session.data['addNote'];
...
router.get('/mvp-1_0/contact-history-detail',function(req,res){
...
router.get('/mvp-1_0/different-type-contact-user/contact-history-detail',function(req,res){
console.log('Details GET route is getting invoked',req.session.data.contextID);
const detailRec = data.contacts.filter((context) => {
context = req.session.data.contextID.includes(context.contextID);
return context;
...
router.get('/mvp-1_0/call-log-journey/added-details',function(req,res){
let notes ='';
if(req.session.data.notes){
if(req.session.data.notes.length>0){
notes =req.session.data.notes + ". "+ req.session.data['addNote'];
...
router.get('/mvp-1_0/different-type-contact-user/call-log-journey/added-details',function(req,res){
let notes ='';
if(req.session.data.notes){
if(req.session.data.notes.length>0){
notes =req.session.data.notes + ". "+ req.session.data['addNote'];
...
router.get('/mvp-1_0/call-log-journey/confirmation-complete-session',function(req,res,next){
let notes ='';
if(req.session.data.notes){
if(req.session.data.notes.length>0){
notes =req.session.data.notes + ". "+ req.session.data['addNote'];
...
router.get('/mvp-1_0/different-type-contact-user/call-log-journey/confirmation-complete-session',function(req,res,next){
let notes ='';
if(req.session.data.notes){
if(req.session.data.notes.length>0){
notes =req.session.data.notes + ". "+ req.session.data['addNote'];
...
router.post('/mvp-1_0/index', function (req, res) {
...
router.post('/mvp-1_0/who-is-calling-or-contacting', function (req, res) {
req.session.data['Who-is-the-engagement-with-sprint23-opt2'] = '';
...
router.post('/mvp-1_0/why-checking-info', function (req, res) {
req.session.data['What-type-of-contact'] = '';
req.session.data['Who-is-the-engagement-with-sprint23-opt2'] = '';
req.session.data['Who-is-contact-with'] = '';
req.session.data['Who-is-the-engagement-with'] = '';
...
router.post('/mvp-1_0/view-only-user/home', function (req, res) {
...
router.post('/mvp-1_0/home', function (req, res) {
...
router.post('/mvp-1_0/different-type-contact-user/home', function (req, res) {
...
router.post('/mvp-1_0/call-log-journey/confirmation-complete-session', function (req, res) {
...
router.post('/mvp-1_0/engagement-log-journey/add-note', function (req, res) {
...
// this is for radio selection for Session complete
router.post('/mvp-1_0/engagement-log-journey/session-completed', function (req, res) {
...
router.post('/mvp-1_0/contact-history-ui',function(req,res){
res.render("/prototype-dev-baseline/mvp-1_0/contact-history")
})

router.post('/mvp-1_0/call-log-journey/selectBenefit', function(req, res) {
...
router.post('/mvp-1_0/call-log-journey/selectQuestion', function(req, res) {
...
router.post('/mvp-1_0/call-log-journey/added-call-details', function(req, res) {
...
if(req.session.data['Othques_wasQuestionResolved'].includes('Not resolved')) {
isOthquesRresolved = 'govuk-tag--grey';
}
...
"isOthquesRresolved": isOthquesRresolved,
})
...
router.post('/mvp-1_0/call-log-journey/checkAnswer2', function(req, res) {
var isNpd = 'govuk-!-display-none';
var isNpa = 'govuk-!-display-none';
var isMp = 'govuk-!-display-none';
var isRfch = 'govuk-!-display-none';
...
router.post('/mvp-1_0/call-log-journey/added-call-details-for-something-else', function(req, res) {
...
router.post('/mvp-1_0/call-log-journey/check-for-add-note', function(req, res) {
//All variable render here
let outcomePageData = [];
outcomePageData = req.session.data.outcomePage ? req.session.data.outcomePage : [];
...
router.post('/mvp-1_0/call-log-journey/add-another-benefit-for-call', function(req, res) {
...
router.post('/mvp-1_0/call-log-journey/confirm_Complete_PhoneCall', function (req, res) {
if(req.session.data.outcomePage === ''){
res.redirect('/prototype-dev-baseline/mvp-1_0/call-log-journey/no-contact-added');
} else {
...
router.post('/mvp-1_0/call-log-journey/updateNote_beforeCompleteCall', function (req, res) {
res.redirect("/prototype-dev-baseline/mvp-1_0/call-log-journey/add-more-reasons-for-call")
});

// Complete session
router.post('/mvp-1_0/call-log-journey/check-phoneCall-completed', function (req, res) {
// Check whether the variable matches a condition
...
router.post('/mvp-1_0/addAnotherBenefit', function(req, res) {
req.session.data['whichBenefitDiscussed'] = '';
req.session.data['questionAsk'] = '';
req.session.data['npd_wasQuestionResolved'] = '';
req.session.data['npa_wasQuestionResolved'] = '';
...
router.post('/mvp-1_0/goToHome', function(req, res) {
...
// Payment history for Telephony user
router.post('/mvp-1_0/payment',function(req,res){
...
router.post('/mvp-1_0/contact-history',function(req,res){
...
// Payment history for Non-telephony users 
router.post('/mvp-1_0/different-type-contact-user/payment',function(req,res){
let paymentTableData;
if (req.body.benefit !== undefined && req.body.benefit !== '' && req.body.benefit !== "_unchecked"){
...
// Contact history filter code start here
router.post('/mvp-1_0/different-type-contact-user/contact-history',function(req,res){
...
router.post('/mvp-1_0/view-only-user/contact-history',function(req,res){
...
// Payment history for view only users 
router.post('/mvp-1_0/different-type-contact-user/payment',function(req,res){
    let paymentTableData;
    if (req.body.benefit !== undefined && req.body.benefit !== '' && req.body.benefit !== "_unchecked"){
    paymentTableData = paymentDataViewOnlyIserMVP1_0.data.filter((context) => {
    context = req.body.benefit.includes(context.benefit);
    return context;
    });
    req.session.data.paymentTableData = paymentTableData;
    ...
    req.session.data.paymentTableFilterCa = false;
    req.session.data.paymentTableFilterPip = false;
    req.session.data.paymentTableData = paymentDataViewOnlyIserMVP1_0.data;
    }
    res.redirect('payment#history');
    });
...
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/confirmation-complete-session', function (req, res) {
// console.log('Value of the session varaible: --------------------------------->',req.session.data['What-services-have-they-called-about']);
if (req.session.data['What-services-have-they-called-about'].includes('esa')) {
...
// this is for radio selection for Session complete
router.post('/mvp-1_0/different-type-contact-user/engagement-log-journey/add-note', function (req, res) {
...
// this is for radio selection for Session complete
router.post('/mvp-1_0/different-type-contact-user/engagement-log-journey/session-completed', function (req, res) {
var completeSession2 = req.session.data['Do-you-want-to-complete-the-session-opt2']
...
router.post('/mvp-1_0/different-type-contact-user/contact-history-ui',function(req,res){
res.render("/prototype-dev-baseline/mvp-1_0/different-type-contact-user/contact-history")
})

router.post('/mvp-1_0/different-type-contact-user/call-log-journey/selectBenefit', function(req, res) {
req.session.data['whichBenefitDiscussed'] = '';
req.session.data['questionAsk'] = '';
req.session.data['npd_wasQuestionResolved'] = '';
req.session.data['npa_wasQuestionResolved'] = '';
...
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/selectQuestion', function(req, res) {
...
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/wasQuestionResolved', function(req, res) {
...
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/check-details', function(req, res) {
...
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/checkAnswer2', function(req, res) {
var isNpd = 'govuk-!-display-none';
var isNpa = 'govuk-!-display-none';
var isMp = 'govuk-!-display-none';
var isRfch = 'govuk-!-display-none';
...
// check answer for something else question type
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/checkAnswerForsomethingElse', function(req, res) {
...
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/check-for-add-note', function(req, res) {
//All variable render here
let outcomePageData = [];
outcomePageData = req.session.data.outcomePage ? req.session.data.outcomePage : [];
req.session.data['questionAsk'].map((item)=>{
...
// /add view already added note
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/add-another-benefit-for-call', function(req, res) {
...
// check phone call progress and complete confirmation.
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/confirm_Complete_PhoneCall', function (req, res) {
if(req.session.data.outcomePage === ''){
...
// update note before complete phone call
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/updateNote_beforeCompleteCall', function (req, res) {
res.redirect("/prototype-dev-baseline/mvp-1_0/different-type-contact-user/call-log-journey/confirmation-complete-session")
});

// Complete session
router.post('/mvp-1_0/different-type-contact-user/call-log-journey/phoneCall-completed', function (req, res) {
...
router.post('/mvp-1_0/start-new-session', function (req, res) {
...
router.post('/mvp-1_0/different-type-contact-user/addAnotherBenefit', function(req, res) {
req.session.data['whichBenefitDiscussed'] = '';
req.session.data['questionAsk'] = '';
req.session.data['npd_wasQuestionResolved'] = '';
req.session.data['npa_wasQuestionResolved'] = '';
...
// Unhappy scenario condition - add another reason?
router.post('/mvp-1_0/different-type-contact-user/goToHome', function(req, res) {
