...
router.post('/add-call/questions-asked', function (req, res) {
  ...
  if (req.session.data['What-type-of-contact'] == 'Log a contact attempt') {
    req.session.data['addNote'] = '';
    res.redirect('/prototype-dev-baseline/mvp-1_3/add-call/add-note-for-failed-outbound');
  } else {
  ...
  if (req.session.data['what-benefit-discussed'] == '')
 {
  ...
  res.redirect('/prototype-dev-baseline/mvp-1_3/add-call/what-benefits-discussed-error');
    ...
    res.redirect('/prototype-dev-baseline/mvp-1_3/add-call/no-benefit');
  } else {
...
router.post('/non-telephony/add-contact/questions-asked', function (req, res) {
  ...
  if (req.session.data['what-benefit-discussed-non-telephony'] == '')
 {
  ...
  res.redirect('/prototype-dev-baseline/mvp-1_3/non-telephony/add-contact/no-benefit');
} else {
