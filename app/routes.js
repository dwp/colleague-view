...
// this is all about opt1 (iteration3)
...
router.post('/sprint27/opt1/engagement-log-journey/benefitPages', function (req, res) {
  ...
  if (isEsa && isPip) {
    res.render('sprint27/opt1/engagement-log-journey/what-queries-dealt-with-ESA', {
      "nextUrl": '/sprint27/opt1/engagement-log-journey/what-queries-dealt-with-PIP',
      "pageLength": pageLength
    });
  }
  if (isEsa && isCa && !isPip) {
    // console.log('considition executed isEsa && isCa && !isPip');
    res.render('sprint27/opt1/engagement-log-journey/what-queries-dealt-with-ESA', {
      "nextUrl": '/sprint27/opt1/engagement-log-journey/what-queries-dealt-with-CA',
      "pageLength": pageLength
    });
  }
  if (isEsa && !isPip && !isCa) {
    // console.log('considition executed isEsa && !isPip && !isCa');
    res.render('sprint27/opt1/engagement-log-journey/what-queries-dealt-with-ESA', {
      "nextUrl": '/sprint27/opt1/engagement-log-journey/outcome-queries',
      "pageLength": pageLength
    });
  }
  if (!isEsa && isPip && isCa) {
    // console.log('considition executed !isEsa && isPip && isCa');
    res.render('sprint27/opt1/engagement-log-journey/what-queries-dealt-with-PIP', {
      "nextUrl": '/sprint27/opt1/engagement-log-journey/what-queries-dealt-with-CA',
      "pageLength": pageLength
    });
  }
  ...
  if (!isEsa && !isPip && isCa) {
    // console.log('considition executed !isEsa && !isPip && isCa');
    res.render('sprint27/opt1/engagement-log-journey/what-queries-dealt-with-CA', {
      "nextUrl": '/sprint27/opt1/engagement-log-journey/outcome-queries',
      "pageLength": pageLength
    });
  }
...
router.post('/sprint27/opt1/engagement-log-journey/what-queries-dealt-with-PIP', function (req, res) {
  var isPip = req.session.data['What-services-have-they-called-about'].includes('pip');
  var isCa = req.session.data['What-services-have-they-called-about'].includes('ca');
  var pageLength = '';
  if (req.session.data['What-services-have-they-called-about'].length == 1) {
...
router.post('/sprint27/opt1/engagement-log-journey/what-queries-dealt-with-CA', function (req, res) {
  var pageLength = '';
  if (req.session.data['What-services-have-they-called-about'].length == 1) {
    pageLength = 'Services 1 of 1';
  } else if (req.session.data['What-services-have-they-called-about'].length == 2) {
...
router.post('/sprint27/opt1/engagement-log-journey/outcome-queries', function (req, res) {
  ...
  res.render('sprint27/opt1/engagement-log-journey/outcome-queries', {
...
//check before complete session

// router.post('/sprint23/opt1/engagement-log-journey/confirmation-complete-session.html', function (req, res) {
//   // var benefitSelected = req.session.data['What-services-have-they-called-about']
//   // if (req.session.data['What-services-have-they-called-about'] == 'esa' || req.session.data['What-services-have-they-called-about'] == 'pip' || req.session.data['What-services-have-they-called-about'] == 'ca') {
//   //   res.redirect('/sprint23/opt1/engagement-log-journey/confirmation-complete-session');
//   // } else {
//   //   res.redirect('/sprint23/opt1/engagement-log-journey/confirmation-complete-session-no-Call-added');
//   // }
