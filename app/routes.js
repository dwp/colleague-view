...
// sprint 23, remember to add older sprint when adding a new folder!
// sprint mvp1.0, remember to add older sprint when adding a new folder!
router.use('/prototype-dev-baseline', require('./views/prototype-dev-baseline/_routes'));
// sprint 23, remember to add older sprint when adding a new folder!
router.use('/prototype-sprint-wise/sprint23', require('./views/prototype-sprint-wise/sprint23/_routes'));
// sprint 22, remember to add older sprint when adding a new folder!
router.use('/prototype-sprint-wise/ur-5', require('./views/prototype-sprint-wise/ur-5/_routes'));
// sprint 19, remember to add older sprint when adding a new folder!
router.use('/prototype-sprint-wise/sprint19', require('./views/prototype-sprint-wise/sprint19/_routes'));
// sprint 13, remember to add older sprint when adding a new folder!
