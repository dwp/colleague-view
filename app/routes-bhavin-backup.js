...
router.post('/sprint23/opt1/engagement-log-journey/confirmation-complete-session', function (req, res) {
  ...
  if (req.session.data['What-services-have-they-called-about'].includes('esa')) {
    ...
    res.redirect('/sprint23/opt1/complete-session/no-contactAdded');
  }
  });
